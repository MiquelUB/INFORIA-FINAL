    ...
    <Card className="bg-card rounded-lg border border-border p-4 h-full flex flex-col">
      ...
      <div className="relative mb-3">
        ...
        <Input
          ...
          className="pl-10 text-sm border-border focus:ring-primary focus:border-primary font-sans bg-background"
        />
      </div>
            ...
            {filteredResults.length > 0 ? (
              filteredResults.map((result) => {
                ...
                return (
                  <div
                    key={result.id}
                    className="flex items-center space-x-2 p-2 bg-background rounded border border-border hover:bg-secondary transition-colors cursor-pointer"
                  >
        ...
        {!searchQuery && (
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              <div className="flex items-center space-x-2 p-2 bg-background rounded border border-border hover:bg-secondary transition-colors cursor-pointer">
                <div className="p-1.5 bg-primary/10 rounded">
