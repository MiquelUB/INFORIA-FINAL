      ...
      <main className="container mx-auto px-6 py-8 max-w-4xl">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {videoTutorials.map((video, index) => (
              <Card key={index} className="border-border hover:shadow-md transition-colors cursor-pointer">
        ...
        <section className="text-center">
          ...
          <a 
            ...
            className="font-sans text-lg text-primary hover:text-primary/80 underline transition-colors"
          >
            soporte@inforia.app
          </a>
        </section>
