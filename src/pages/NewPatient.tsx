                  ...
                  <div className="space-y-2">
                    ...
                    {/* <Popover> */}
                      {/* <PopoverTrigger asChild> */}
                        <Button
                          variant="outline"
                          className={`w-full justify-start text-left font-sans ${!patientData.birthDate ? "text-muted-foreground" : ""}`}
                        >
                          <Calendar className="mr-2 h-4 w-4" />
                          {patientData.birthDate ? (
                            new Date(patientData.birthDate).toLocaleDateString('es-ES', { month: 'numeric', day: 'numeric', hour: 'numeric', minute: 'numeric' })
                          ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    {/* <Popover> */}
                      {/* <PopoverTrigger asChild> */}
                        <Button
                          variant="outline"
                          className={`w-full justify-start text-left font-sans ${!patientData.appointmentDate ? "text-muted-foreground" : ""}`}
                        >
                          <Calendar className="mr-2 h-4 w-4" />
                          {patientData.appointmentDate ? (
                            new Date(patientData.appointmentDate).toLocaleDateString('es-ES', { month: 'numeric', day: 'numeric', hour: 'numeric', minute: 'numeric' })
                          ) : (
